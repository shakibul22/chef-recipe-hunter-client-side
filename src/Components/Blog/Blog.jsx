...
const Blog = () => {
    return (
        <div className=' text-start flex flex-col gap-6 shadow p-6 mb-8'>
            ...
            <div className='shadow p-5'>
                <h3 className='font-semibold mb-4'>c. Tell us the difference between nodejs and express js.
                </h3>
            ...
            <div className='shadow p-5'>
                <h3 className='font-semibold mb-4'> d. What is a custom hook, and why will you create a custom hook?</h3>
